...
import friendRatingsRepository from "../repositories/friendRatings.repository";
...
const FriendRatingsController = new friendRatingsController(FriendRatingsUseCase);
...
FriendRatingsRoute.get(
    ...
    FriendRatingsController.requestRetrieveFollowingsFollowers.bind(FriendRatingsController))
